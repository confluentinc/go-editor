...
## Auto Sync
The cc-mk-include now provide solution to auto-sync your repo with the newest or pinned version of cc-mk-include. It will *auto open* a PR if your master branch is not at the same version with newest or pinned version. And it will *auto merged* if the CI passed. To use it, first you must have cc-begin.mk and cc-semver.mk in your toplevel Makefile. Then you need to add
```shell
